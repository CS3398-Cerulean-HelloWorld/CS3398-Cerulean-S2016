...
namespace CCore
{
	...
	public:
		...
		//functions to directly set the button bounds
		...
		//functions to get the button bounds
		int getX1() { return X1; }
		int getY1() { return Y1; }
	...
	//function to set button position and size
	void CButton::setBox(int X_pos, int Y_pos, int width, int height)
	{
		X1 = X_pos;
		Y1 = Y_pos;
	...
	//function to set button X position, maintaining button width.
	void CButton::setX(int X_pos)
	{
		int Width = X2 - X1;
	...
	//function to set button Y position, maintaining button height.
	void CButton::setY(int Y_pos)
	{
		int Height = Y2 - Y1;
